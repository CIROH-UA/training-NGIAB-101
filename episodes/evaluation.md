...
A TEEHR evaluation run is automatically offered upon execution of `guide.sh`. A separate `runTeehr.sh` script is also available in the NGIAB-CloudInfra repository.
...
Go ahead and execute the TEEHR run using `guide.sh` and explore your TEEHR folder (located in your run directory)!
