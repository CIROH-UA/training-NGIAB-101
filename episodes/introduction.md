...
Several extensions of NGIAB are already integrated with NextGen-related tools like [Data Preprocess](./data-preprocessor.html), [Tools for Exploratory Evaluation in Hydrologic Research (TEEHR)](./teehr.html), and [Data Visualizer](./visualization.html) (Figure 2). These extensions will be discussed in later episodes.
